...
func testEval(input string) object.Object {
	...
	return Eval(program, env) // call Eval()
}
...
func testIntegerObject(t *testing.T, obj object.Object, expected int64) bool {
	...
	if result.Value != expected {
		t.Errorf("object's value not %d. got=%d", expected, result.Value)
		return false
	}
...
func testBooleanObject(t *testing.T, obj object.Object, expected bool) bool {
	...
	if result.Value != expected {
		t.Errorf("object's value not %T. got=%T", expected, result.Value)
		return false
	}
...
func TestFunctionApplication(t *testing.T) {
	test := []struct {
		...
		{"let identity = fn(x) { x; }; identity(5);", 5},        // return value implicitly
		{"let identity = fn(x) { return x; }; identity(5);", 5}, // return value using return statement
...
func TestStringVConcatenation(t *testing.T) {
	input := `"Hello" + " " + "World!"`
...
func TestBuiltinFunctions(t *testing.T) {
	...
	for _, tt := range tests {
		evaluated := testEval(tt.input)
		// according to the type of `expected`, get the results
